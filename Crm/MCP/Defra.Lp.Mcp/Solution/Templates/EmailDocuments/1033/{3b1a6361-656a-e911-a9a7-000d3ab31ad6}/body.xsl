...
deadline specified below.</p><p class=MsoNormal><b><span style="font-family:&quot;Arial&quot;,sans-serif;background:yellow;">Regulatory officer actions</span></b><b><span style="font-family:&quot;Arial&quot;,sans-serif;"> - complete highlighted sections in
table below</span></b><br></p><p class=MsoNormal></p><table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 style="margin-left:1.0cm;border-collapse:collapse;">
 ...
 <tr class=keyboardFocusClass>
  ...
  <td width=404 colspan=2 valign=top style="width:303.3pt;border-top:none;border-left:none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;padding:0cm 5.4pt 0cm 5.4pt;" class=keyboardFocusClass>]]><xsl:choose><xsl:when test="defra_application/defra_site_description"><xsl:value-of select="defra_application/defra_site_description" /></xsl:when><xsl:otherwise></xsl:otherwise></xsl:choose><![CDATA[<p class=MsoNormal></p></td></tr><tr class=keyboardFocusClass><td width=179 valign=top style="width:134.45pt;border:solid windowtext 1.0pt;border-top:none;padding:0cm 5.4pt 0cm 5.4pt;"><p class=MsoNormal style="margin-bottom:6.0pt;"><span style="color:windowtext;">Application Ref</span></p>
  </td>
 ...
 <tr class=keyboardFocusClass>
  ...
  <p class=MsoNormal>]]><xsl:choose><xsl:when test="defra_application/defra_permittingteamleaderid/@name"><xsl:value-of select="defra_application/defra_permittingteamleaderid/@name" /></xsl:when><xsl:otherwise></xsl:otherwise></xsl:choose><![CDATA[ </p>
  </td>
 </tr>
 <tr class=keyboardFocusClass>
  <td width=179 valign=top style="width:134.45pt;border:solid windowtext 1.0pt;border-top:none;padding:0cm 5.4pt 0cm 5.4pt;">
  ...
  <p class=MsoNormal style="margin-bottom:6.0pt;"><span style="color:#FF3399;">Delete as applicable.
  Options in red apply to waste, installations and water quality. Options in
  green apply to water resources. </span></p>
  <p class=MsoNormal style="margin-bottom:6.0pt;"><span style="color:red;">Waste operation, Installation, Water
  discharge activity, Groundwater activity </span><span style="color:#00B050;">Water resources activities</span></p>
  <p class=MsoNormal style="margin-bottom:6.0pt;"><span style="color:red;">New bespoke, Standard Rules,
  Admin/Minor technical/Normal/Substantial variation, Transfer, Surrender</span></p>
  <p class="MsoNormal keyboardFocusClass" style="margin-bottom:6.0pt;"><span style="color:#00B050;">New full, new transfer, new
  temporary, renewals, impoundment, formal variation</span><span style="color:red;"></span></p>
  </td>
 </tr>
 <tr>
  <td width=179 valign=top style="width:134.45pt;border:solid windowtext 1.0pt;border-top:none;padding:0cm 5.4pt 0cm 5.4pt;">
  ...
  been agreed in discussion with area</span><span style="color:windowtext;"></span></p>
  </td>
 </tr>
 <tr>
 ...
 <tr>
  ...
  <td width=404 colspan=2 valign=top style="width:303.3pt;border-top:none;border-left:none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;padding:0cm 5.4pt 0cm 5.4pt;">
  <p class=MsoNormal><span style="color:#FF3399;">You need to let NPS and the new Operator know if
 ...
 <tr style="height:39.1pt;" class=keyboardFocusClass>
  <td width=584 colspan=3 valign=top style="width:437.75pt;border:solid windowtext 1.0pt;border-top:none;padding:0cm 5.4pt 0cm 5.4pt;height:39.1pt;">
  <p class=MsoNormal style="margin-bottom:6.0pt;"><span style="color:windowtext;">I agree with the
