...
namespace WastePermits.Model.EarlyBound
{
	...
	public partial class defra_exception : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		/// <summary>
		/// Unique identifier for Standard Rule associated with Exception.
		/// </summary>
		...
		public System.Nullable<WastePermits.Model.EarlyBound.defra_exceptionState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((WastePermits.Model.EarlyBound.defra_exceptionState)(System.Enum.ToObject(typeof(WastePermits.Model.EarlyBound.defra_exceptionState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<WastePermits.Model.EarlyBound.defra_exception> Referenceddefra_exception_defra_exception
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<WastePermits.Model.EarlyBound.defra_exception>("defra_exception_defra_exception", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Referenceddefra_exception_defra_exception");
				this.SetRelatedEntities<WastePermits.Model.EarlyBound.defra_exception>("defra_exception_defra_exception", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public WastePermits.Model.EarlyBound.defra_applicationline defra_applicationline_defra_exception_applicationlineid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<WastePermits.Model.EarlyBound.defra_applicationline>("defra_applicationline_defra_exception_applicationlineid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("defra_applicationline_defra_exception_applicationlineid");
				this.SetRelatedEntity<WastePermits.Model.EarlyBound.defra_applicationline>("defra_applicationline_defra_exception_applicationlineid", null, value);
		...
		public WastePermits.Model.EarlyBound.defra_exception Referencingdefra_exception_defra_exception
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<WastePermits.Model.EarlyBound.defra_exception>("defra_exception_defra_exception", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Referencingdefra_exception_defra_exception");
				this.SetRelatedEntity<WastePermits.Model.EarlyBound.defra_exception>("defra_exception_defra_exception", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
				this.OnPropertyChanged("Referencingdefra_exception_defra_exception");
			}
		}
		
		/// <summary>
		/// N:1 defra_standardrule_defra_exception
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("defra_standardruleid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("defra_standardrule_defra_exception")]
		public WastePermits.Model.EarlyBound.defra_standardrule defra_standardrule_defra_exception
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<WastePermits.Model.EarlyBound.defra_standardrule>("defra_standardrule_defra_exception", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
