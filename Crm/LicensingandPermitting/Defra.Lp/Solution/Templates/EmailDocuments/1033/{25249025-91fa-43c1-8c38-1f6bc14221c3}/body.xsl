<?xml version="1.0" ?><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"><xsl:output method="text" indent="no"/><xsl:template match="/data"><![CDATA[<p>This Microsoft Dynamics CRM duplication-detection task completed successfully.</p>
					...
					<p>Click <A name="slugAnchorTag"  href="#">https://AG-EA-LP-DEV-CORELP.crm4.dynamics.com/tools/asyncoperation/edit.aspx?id=]]><xsl:choose><xsl:when test="asyncoperation/asyncoperationid"><xsl:value-of select="asyncoperation/asyncoperationid" /></xsl:when><xsl:otherwise></xsl:otherwise></xsl:choose><![CDATA[</A></p>
					<p>or</p>
