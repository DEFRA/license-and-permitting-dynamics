...
namespace Lp.Model.EarlyBound
{
	...
	public partial class SdkMessageRequest : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Lp.Model.EarlyBound.SdkMessageRequestField> messagerequest_sdkmessagerequestfield
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Lp.Model.EarlyBound.SdkMessageRequestField>("messagerequest_sdkmessagerequestfield", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("messagerequest_sdkmessagerequestfield");
				this.SetRelatedEntities<Lp.Model.EarlyBound.SdkMessageRequestField>("messagerequest_sdkmessagerequestfield", null, value);
		...
		public System.Collections.Generic.IEnumerable<Lp.Model.EarlyBound.SdkMessageResponse> messagerequest_sdkmessageresponse
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Lp.Model.EarlyBound.SdkMessageResponse>("messagerequest_sdkmessageresponse", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("messagerequest_sdkmessageresponse");
				this.SetRelatedEntities<Lp.Model.EarlyBound.SdkMessageResponse>("messagerequest_sdkmessageresponse", null, value);
		...
		public System.Collections.Generic.IEnumerable<Lp.Model.EarlyBound.UserEntityInstanceData> userentityinstancedata_sdkmessagerequest
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Lp.Model.EarlyBound.UserEntityInstanceData>("userentityinstancedata_sdkmessagerequest", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_sdkmessagerequest");
				this.SetRelatedEntities<Lp.Model.EarlyBound.UserEntityInstanceData>("userentityinstancedata_sdkmessagerequest", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser createdby_sdkmessagerequest
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("createdby_sdkmessagerequest", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_sdkmessagerequest_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_sdkmessagerequest_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_sdkmessagerequest_createdonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_sdkmessagerequest_createdonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_sdkmessagerequest_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_sdkmessagerequest_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_sdkmessagerequest_modifiedonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_sdkmessagerequest_modifiedonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SdkMessagePair messagepair_sdkmessagerequest
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SdkMessagePair>("messagepair_sdkmessagerequest", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser modifiedby_sdkmessagerequest
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("modifiedby_sdkmessagerequest", null);
			}
		}
		...
		public Lp.Model.EarlyBound.Organization organization_sdkmessagerequest
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.Organization>("organization_sdkmessagerequest", null);
			}
		}
