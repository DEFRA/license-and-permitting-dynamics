...
namespace Lp.Model.EarlyBound
{
	...
	public partial class defra_notification : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Lp.Model.EarlyBound.defra_notificationState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Lp.Model.EarlyBound.defra_notificationState)(System.Enum.ToObject(typeof(Lp.Model.EarlyBound.defra_notificationState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public Lp.Model.EarlyBound.Account account_defra_notifications
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.Account>("account_defra_notifications", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
		...
		public Lp.Model.EarlyBound.defra_application defra_application_defra_notifications
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.defra_application>("defra_application_defra_notifications", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
		...
		public Lp.Model.EarlyBound.defra_payment defra_payment_defra_notifications
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.defra_payment>("defra_payment_defra_notifications", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("defra_payment_defra_notifications");
				this.SetRelatedEntity<Lp.Model.EarlyBound.defra_payment>("defra_payment_defra_notifications", null, value);
		...
		public Lp.Model.EarlyBound.defra_permit defra_permit_defra_notifications
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.defra_permit>("defra_permit_defra_notifications", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("defra_permit_defra_notifications");
				this.SetRelatedEntity<Lp.Model.EarlyBound.defra_permit>("defra_permit_defra_notifications", null, value);
		...
		public Lp.Model.EarlyBound.Incident incident_defra_notifications
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.Incident>("incident_defra_notifications", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
