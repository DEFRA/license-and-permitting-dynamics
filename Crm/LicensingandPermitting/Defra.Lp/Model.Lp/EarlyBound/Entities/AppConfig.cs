...
namespace Lp.Model.EarlyBound
{
	...
	public partial class AppConfig : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Lp.Model.EarlyBound.AppConfigState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Lp.Model.EarlyBound.AppConfigState)(System.Enum.ToObject(typeof(Lp.Model.EarlyBound.AppConfigState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Lp.Model.EarlyBound.AppConfigInstance> appconfig_appconfiginstance
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Lp.Model.EarlyBound.AppConfigInstance>("appconfig_appconfiginstance", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("appconfig_appconfiginstance");
				this.SetRelatedEntities<Lp.Model.EarlyBound.AppConfigInstance>("appconfig_appconfiginstance", null, value);
		...
		public System.Collections.Generic.IEnumerable<Lp.Model.EarlyBound.NavigationSetting> navigationsetting_appconfig
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Lp.Model.EarlyBound.NavigationSetting>("navigationsetting_appconfig", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("navigationsetting_appconfig");
				this.SetRelatedEntities<Lp.Model.EarlyBound.NavigationSetting>("navigationsetting_appconfig", null, value);
		...
		public Lp.Model.EarlyBound.AppModule appmodule_appconfig
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.AppModule>("appmodule_appconfig", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("appmodule_appconfig");
				this.SetRelatedEntity<Lp.Model.EarlyBound.AppModule>("appmodule_appconfig", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_appconfig_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_appconfig_createdby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_appconfig_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_appconfig_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_appconfig_createdonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_appconfig_createdonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_appconfig_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_appconfig_modifiedby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_appconfig_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_appconfig_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_appconfig_modifiedonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_appconfig_modifiedonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.Organization organization_appconfig
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.Organization>("organization_appconfig", null);
			}
		}
