...
namespace Lp.Model.EarlyBound
{
	...
	public partial class CustomControlResource : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Lp.Model.EarlyBound.CustomControl customcontrol_resource_id
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.CustomControl>("customcontrol_resource_id", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("customcontrol_resource_id");
				this.SetRelatedEntity<Lp.Model.EarlyBound.CustomControl>("customcontrol_resource_id", null, value);
		...
		public Lp.Model.EarlyBound.Organization customcontrolresource_organization
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.Organization>("customcontrolresource_organization", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_customcontrolresource_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_customcontrolresource_createdby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_customcontrolresource_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_customcontrolresource_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_customcontrolresource_createdonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_customcontrolresource_createdonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_customcontrolresource_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_customcontrolresource_modifiedby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_customcontrolresource_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_customcontrolresource_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_customcontrolresource_modifiedonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_customcontrolresource_modifiedonbehalfby", null, value);
