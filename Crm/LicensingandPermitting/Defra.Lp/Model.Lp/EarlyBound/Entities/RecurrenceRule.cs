...
namespace Lp.Model.EarlyBound
{
	...
	public partial class RecurrenceRule : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Lp.Model.EarlyBound.RecurringAppointmentMaster> recurrencerule_recurringappointmentmaster
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Lp.Model.EarlyBound.RecurringAppointmentMaster>("recurrencerule_recurringappointmentmaster", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("recurrencerule_recurringappointmentmaster");
				this.SetRelatedEntities<Lp.Model.EarlyBound.RecurringAppointmentMaster>("recurrencerule_recurringappointmentmaster", null, value);
		...
		public Lp.Model.EarlyBound.ActivityPointer activity_pointer_recurrencerule
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.ActivityPointer>("activity_pointer_recurrencerule", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("activity_pointer_recurrencerule");
				this.SetRelatedEntity<Lp.Model.EarlyBound.ActivityPointer>("activity_pointer_recurrencerule", null, value);
		...
		public Lp.Model.EarlyBound.BusinessUnit business_unit_recurrencerule
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.BusinessUnit>("business_unit_recurrencerule", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_recurrencerule_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_recurrencerule_createdby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_recurrencerule_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_recurrencerule_modifiedby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_recurrencerulebase_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_recurrencerulebase_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_recurrencerulebase_createdonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_recurrencerulebase_createdonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_recurrencerulebase_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_recurrencerulebase_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_recurrencerulebase_modifiedonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_recurrencerulebase_modifiedonbehalfby", null, value);
