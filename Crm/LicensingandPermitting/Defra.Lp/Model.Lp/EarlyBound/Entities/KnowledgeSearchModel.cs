...
namespace Lp.Model.EarlyBound
{
	...
	public partial class KnowledgeSearchModel : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Lp.Model.EarlyBound.KnowledgeSearchModelState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Lp.Model.EarlyBound.KnowledgeSearchModelState)(System.Enum.ToObject(typeof(Lp.Model.EarlyBound.KnowledgeSearchModelState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Lp.Model.EarlyBound.TextAnalyticsEntityMapping> knowledgesearchmodel_textanalyticsentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Lp.Model.EarlyBound.TextAnalyticsEntityMapping>("knowledgesearchmodel_textanalyticsentitymapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("knowledgesearchmodel_textanalyticsentitymapping");
				this.SetRelatedEntities<Lp.Model.EarlyBound.TextAnalyticsEntityMapping>("knowledgesearchmodel_textanalyticsentitymapping", null, value);
		...
		public Lp.Model.EarlyBound.AzureServiceConnection azureserviceconnection_knowledgesearchmodel
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.AzureServiceConnection>("azureserviceconnection_knowledgesearchmodel", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("azureserviceconnection_knowledgesearchmodel");
				this.SetRelatedEntity<Lp.Model.EarlyBound.AzureServiceConnection>("azureserviceconnection_knowledgesearchmodel", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_knowledgesearchmodel_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_knowledgesearchmodel_createdby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_knowledgesearchmodel_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_knowledgesearchmodel_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_knowledgesearchmodel_createdonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_knowledgesearchmodel_createdonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_knowledgesearchmodel_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_knowledgesearchmodel_modifiedby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_knowledgesearchmodel_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_knowledgesearchmodel_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_knowledgesearchmodel_modifiedonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_knowledgesearchmodel_modifiedonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.Organization organization_knowledgesearchmodel
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.Organization>("organization_knowledgesearchmodel", null);
			}
		}
