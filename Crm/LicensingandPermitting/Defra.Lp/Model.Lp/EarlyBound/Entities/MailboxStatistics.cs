...
namespace Lp.Model.EarlyBound
{
	...
	public partial class MailboxStatistics : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Lp.Model.EarlyBound.Mailbox mailbox_mailboxstatistics
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.Mailbox>("mailbox_mailboxstatistics", null);
			}
		}
		...
		public Lp.Model.EarlyBound.Organization organization_mailboxstatistics
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.Organization>("organization_mailboxstatistics", null);
			}
		}
