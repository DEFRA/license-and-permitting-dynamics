...
namespace Lp.Model.EarlyBound
{
	...
	public partial class ChannelProperty : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Lp.Model.EarlyBound.ChannelPropertyState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Lp.Model.EarlyBound.ChannelPropertyState)(System.Enum.ToObject(typeof(Lp.Model.EarlyBound.ChannelPropertyState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public Lp.Model.EarlyBound.Organization channelproperty_organization
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.Organization>("channelproperty_organization", null);
			}
		}
		...
		public Lp.Model.EarlyBound.ChannelPropertyGroup ChannelPropertyGroup_ChannelProperty
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.ChannelPropertyGroup>("ChannelPropertyGroup_ChannelProperty", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ChannelPropertyGroup_ChannelProperty");
				this.SetRelatedEntity<Lp.Model.EarlyBound.ChannelPropertyGroup>("ChannelPropertyGroup_ChannelProperty", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_ChannelProperty_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_ChannelProperty_createdby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_ChannelProperty_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_ChannelProperty_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_ChannelProperty_createdonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_ChannelProperty_createdonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_ChannelProperty_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_ChannelProperty_modifiedby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_ChannelProperty_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_ChannelProperty_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_ChannelProperty_modifiedonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_ChannelProperty_modifiedonbehalfby", null, value);
