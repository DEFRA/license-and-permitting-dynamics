...
namespace Lp.Model.EarlyBound
{
	...
	public partial class BulkDeleteOperation : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Lp.Model.EarlyBound.BulkDeleteOperationState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Lp.Model.EarlyBound.BulkDeleteOperationState)(System.Enum.ToObject(typeof(Lp.Model.EarlyBound.BulkDeleteOperationState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Lp.Model.EarlyBound.BulkDeleteFailure> BulkDeleteOperation_BulkDeleteFailure
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Lp.Model.EarlyBound.BulkDeleteFailure>("BulkDeleteOperation_BulkDeleteFailure", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("BulkDeleteOperation_BulkDeleteFailure");
				this.SetRelatedEntities<Lp.Model.EarlyBound.BulkDeleteFailure>("BulkDeleteOperation_BulkDeleteFailure", null, value);
		...
		public System.Collections.Generic.IEnumerable<Lp.Model.EarlyBound.UserEntityInstanceData> userentityinstancedata_bulkdeleteoperation
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Lp.Model.EarlyBound.UserEntityInstanceData>("userentityinstancedata_bulkdeleteoperation", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_bulkdeleteoperation");
				this.SetRelatedEntities<Lp.Model.EarlyBound.UserEntityInstanceData>("userentityinstancedata_bulkdeleteoperation", null, value);
		...
		public Lp.Model.EarlyBound.AsyncOperation AsyncOperation_BulkDeleteOperation
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.AsyncOperation>("AsyncOperation_BulkDeleteOperation", null);
			}
		}
		...
		public Lp.Model.EarlyBound.BusinessUnit BulkDeleteOperation_BusinessUnit
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.BusinessUnit>("BulkDeleteOperation_BusinessUnit", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_bulkdeleteoperation_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_bulkdeleteoperation_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_bulkdeleteoperation_createdonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_bulkdeleteoperation_createdonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_bulkdeleteoperation_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_bulkdeleteoperation_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_bulkdeleteoperation_modifiedonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_bulkdeleteoperation_modifiedonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_bulkdeleteoperationbase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_bulkdeleteoperationbase_createdby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_bulkdeleteoperationbase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_bulkdeleteoperationbase_modifiedby", null);
			}
		}
