...
namespace Lp.Model.EarlyBound
{
	...
	public partial class TextAnalyticsEntityMapping : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Lp.Model.EarlyBound.AdvancedSimilarityRule advancedsimilarityrule_textanalyticsentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.AdvancedSimilarityRule>("advancedsimilarityrule_textanalyticsentitymapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("advancedsimilarityrule_textanalyticsentitymapping");
				this.SetRelatedEntity<Lp.Model.EarlyBound.AdvancedSimilarityRule>("advancedsimilarityrule_textanalyticsentitymapping", null, value);
		...
		public Lp.Model.EarlyBound.KnowledgeSearchModel knowledgesearchmodel_textanalyticsentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.KnowledgeSearchModel>("knowledgesearchmodel_textanalyticsentitymapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("knowledgesearchmodel_textanalyticsentitymapping");
				this.SetRelatedEntity<Lp.Model.EarlyBound.KnowledgeSearchModel>("knowledgesearchmodel_textanalyticsentitymapping", null, value);
		...
		public Lp.Model.EarlyBound.Organization organization_textanalyticsentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.Organization>("organization_textanalyticsentitymapping", null);
			}
		}
		...
		public Lp.Model.EarlyBound.TopicModelConfiguration topicmodelconfiguration_textanalyticsentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.TopicModelConfiguration>("topicmodelconfiguration_textanalyticsentitymapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("topicmodelconfiguration_textanalyticsentitymapping");
				this.SetRelatedEntity<Lp.Model.EarlyBound.TopicModelConfiguration>("topicmodelconfiguration_textanalyticsentitymapping", null, value);
