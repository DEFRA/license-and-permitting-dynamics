...
namespace Lp.Model.EarlyBound
{
	...
	public partial class ACIViewMapper : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Lp.Model.EarlyBound.ACIViewMapperState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Lp.Model.EarlyBound.ACIViewMapperState)(System.Enum.ToObject(typeof(Lp.Model.EarlyBound.ACIViewMapperState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public Lp.Model.EarlyBound.SystemUser lk_ACIViewMapper_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_ACIViewMapper_createdby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_ACIViewMapper_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_ACIViewMapper_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_ACIViewMapper_createdonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_ACIViewMapper_createdonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_ACIViewMapper_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_ACIViewMapper_modifiedby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_ACIViewMapper_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_ACIViewMapper_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_ACIViewMapper_modifiedonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_ACIViewMapper_modifiedonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.Organization organization_aciviewmapper
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.Organization>("organization_aciviewmapper", null);
			}
		}
