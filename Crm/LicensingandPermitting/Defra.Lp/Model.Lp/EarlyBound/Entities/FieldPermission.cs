...
namespace Lp.Model.EarlyBound
{
	...
	public partial class FieldPermission : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Lp.Model.EarlyBound.SyncError> FieldPermission_SyncErrors
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Lp.Model.EarlyBound.SyncError>("FieldPermission_SyncErrors", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("FieldPermission_SyncErrors");
				this.SetRelatedEntities<Lp.Model.EarlyBound.SyncError>("FieldPermission_SyncErrors", null, value);
		...
		public System.Collections.Generic.IEnumerable<Lp.Model.EarlyBound.UserEntityInstanceData> userentityinstancedata_fieldpermission
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Lp.Model.EarlyBound.UserEntityInstanceData>("userentityinstancedata_fieldpermission", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_fieldpermission");
				this.SetRelatedEntities<Lp.Model.EarlyBound.UserEntityInstanceData>("userentityinstancedata_fieldpermission", null, value);
		...
		public Lp.Model.EarlyBound.FieldSecurityProfile lk_fieldpermission_fieldsecurityprofileid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.FieldSecurityProfile>("lk_fieldpermission_fieldsecurityprofileid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_fieldpermission_fieldsecurityprofileid");
				this.SetRelatedEntity<Lp.Model.EarlyBound.FieldSecurityProfile>("lk_fieldpermission_fieldsecurityprofileid", null, value);
		...
		public Lp.Model.EarlyBound.Solution solution_fieldpermission
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.Solution>("solution_fieldpermission", null);
			}
		}
