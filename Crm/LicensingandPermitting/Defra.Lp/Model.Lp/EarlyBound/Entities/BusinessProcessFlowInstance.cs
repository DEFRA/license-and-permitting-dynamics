...
namespace Lp.Model.EarlyBound
{
	...
	public partial class BusinessProcessFlowInstance : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Lp.Model.EarlyBound.BusinessProcessFlowInstanceState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Lp.Model.EarlyBound.BusinessProcessFlowInstanceState)(System.Enum.ToObject(typeof(Lp.Model.EarlyBound.BusinessProcessFlowInstanceState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public Lp.Model.EarlyBound.SystemUser lk_businessprocessflowinstancebase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_businessprocessflowinstancebase_createdby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_businessprocessflowinstancebase_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_businessprocessflowinstancebase_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_businessprocessflowinstancebase_createdonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_businessprocessflowinstancebase_createdonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_businessprocessflowinstancebase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_businessprocessflowinstancebase_modifiedby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_businessprocessflowinstancebase_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_businessprocessflowinstancebase_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_businessprocessflowinstancebase_modifiedonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_businessprocessflowinstancebase_modifiedonbehalfby", null, value);
