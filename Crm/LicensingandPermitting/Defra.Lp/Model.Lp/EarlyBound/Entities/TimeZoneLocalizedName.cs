...
namespace Lp.Model.EarlyBound
{
	...
	public partial class TimeZoneLocalizedName : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Lp.Model.EarlyBound.UserEntityInstanceData> userentityinstancedata_timezonelocalizedname
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Lp.Model.EarlyBound.UserEntityInstanceData>("userentityinstancedata_timezonelocalizedname", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("userentityinstancedata_timezonelocalizedname");
				this.SetRelatedEntities<Lp.Model.EarlyBound.UserEntityInstanceData>("userentityinstancedata_timezonelocalizedname", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_timezonelocalizedname_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_timezonelocalizedname_createdby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_timezonelocalizedname_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_timezonelocalizedname_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_timezonelocalizedname_createdonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_timezonelocalizedname_createdonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_timezonelocalizedname_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_timezonelocalizedname_modifiedby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_timezonelocalizedname_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_timezonelocalizedname_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_timezonelocalizedname_modifiedonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_timezonelocalizedname_modifiedonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.TimeZoneDefinition lk_timezonelocalizedname_timezonedefinitionid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.TimeZoneDefinition>("lk_timezonelocalizedname_timezonedefinitionid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_timezonelocalizedname_timezonedefinitionid");
				this.SetRelatedEntity<Lp.Model.EarlyBound.TimeZoneDefinition>("lk_timezonelocalizedname_timezonedefinitionid", null, value);
