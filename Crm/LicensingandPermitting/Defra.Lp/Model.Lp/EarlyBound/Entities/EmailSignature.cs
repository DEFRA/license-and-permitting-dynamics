...
namespace Lp.Model.EarlyBound
{
	...
	public partial class EmailSignature : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Lp.Model.EarlyBound.BusinessUnit business_unit_emailsignatures
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.BusinessUnit>("business_unit_emailsignatures", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_emailsignaturebase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_emailsignaturebase_createdby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_emailsignaturebase_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_emailsignaturebase_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_emailsignaturebase_createdonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_emailsignaturebase_createdonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_emailsignaturebase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_emailsignaturebase_modifiedby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_emailsignaturebase_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_emailsignaturebase_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_emailsignaturebase_modifiedonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_emailsignaturebase_modifiedonbehalfby", null, value);
