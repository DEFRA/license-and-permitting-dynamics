...
namespace Lp.Model.EarlyBound
{
	...
	public partial class ExternalPartyItem : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Lp.Model.EarlyBound.ExternalPartyItemState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Lp.Model.EarlyBound.ExternalPartyItemState)(System.Enum.ToObject(typeof(Lp.Model.EarlyBound.ExternalPartyItemState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Lp.Model.EarlyBound.AsyncOperation> externalpartyitem_AsyncOperations
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Lp.Model.EarlyBound.AsyncOperation>("externalpartyitem_AsyncOperations", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("externalpartyitem_AsyncOperations");
				this.SetRelatedEntities<Lp.Model.EarlyBound.AsyncOperation>("externalpartyitem_AsyncOperations", null, value);
		...
		public System.Collections.Generic.IEnumerable<Lp.Model.EarlyBound.BulkDeleteFailure> externalpartyitem_BulkDeleteFailures
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Lp.Model.EarlyBound.BulkDeleteFailure>("externalpartyitem_BulkDeleteFailures", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("externalpartyitem_BulkDeleteFailures");
				this.SetRelatedEntities<Lp.Model.EarlyBound.BulkDeleteFailure>("externalpartyitem_BulkDeleteFailures", null, value);
		...
		public System.Collections.Generic.IEnumerable<Lp.Model.EarlyBound.ProcessSession> externalpartyitem_ProcessSession
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Lp.Model.EarlyBound.ProcessSession>("externalpartyitem_ProcessSession", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("externalpartyitem_ProcessSession");
				this.SetRelatedEntities<Lp.Model.EarlyBound.ProcessSession>("externalpartyitem_ProcessSession", null, value);
		...
		public System.Collections.Generic.IEnumerable<Lp.Model.EarlyBound.SyncError> ExternalPartyItem_SyncErrors
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Lp.Model.EarlyBound.SyncError>("ExternalPartyItem_SyncErrors", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ExternalPartyItem_SyncErrors");
				this.SetRelatedEntities<Lp.Model.EarlyBound.SyncError>("ExternalPartyItem_SyncErrors", null, value);
		...
		public Lp.Model.EarlyBound.Contact Contact_ExternalPartyItems
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.Contact>("Contact_ExternalPartyItems", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Contact_ExternalPartyItems");
				this.SetRelatedEntity<Lp.Model.EarlyBound.Contact>("Contact_ExternalPartyItems", null, value);
		...
		public Lp.Model.EarlyBound.ExternalParty externalparty_entries
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.ExternalParty>("externalparty_entries", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("externalparty_entries");
				this.SetRelatedEntity<Lp.Model.EarlyBound.ExternalParty>("externalparty_entries", null, value);
		...
		public Lp.Model.EarlyBound.ChannelAccessProfile lk_externalpartyitem_channelaccessprofileid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.ChannelAccessProfile>("lk_externalpartyitem_channelaccessprofileid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_externalpartyitem_channelaccessprofileid");
				this.SetRelatedEntity<Lp.Model.EarlyBound.ChannelAccessProfile>("lk_externalpartyitem_channelaccessprofileid", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_externalpartyitem_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_externalpartyitem_createdby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_externalpartyitem_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_externalpartyitem_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_externalpartyitem_createdonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_externalpartyitem_createdonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_externalpartyitem_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_externalpartyitem_modifiedby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_externalpartyitem_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_externalpartyitem_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_externalpartyitem_modifiedonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_externalpartyitem_modifiedonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser SystemUser_ExternalPartyItems
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("SystemUser_ExternalPartyItems", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("SystemUser_ExternalPartyItems");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("SystemUser_ExternalPartyItems", null, value);
		...
		public Lp.Model.EarlyBound.TransactionCurrency TransactionCurrency_externalpartyitem
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.TransactionCurrency>("TransactionCurrency_externalpartyitem", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("TransactionCurrency_externalpartyitem");
				this.SetRelatedEntity<Lp.Model.EarlyBound.TransactionCurrency>("TransactionCurrency_externalpartyitem", null, value);
