...
namespace Lp.Model.EarlyBound
{
	...
	public partial class KnowledgeArticleViews : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Lp.Model.EarlyBound.KnowledgeArticleViewsState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Lp.Model.EarlyBound.KnowledgeArticleViewsState)(System.Enum.ToObject(typeof(Lp.Model.EarlyBound.KnowledgeArticleViewsState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Lp.Model.EarlyBound.PrincipalObjectAttributeAccess> knowledgearticleview_principalobjectattributeaccess
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Lp.Model.EarlyBound.PrincipalObjectAttributeAccess>("knowledgearticleview_principalobjectattributeaccess", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("knowledgearticleview_principalobjectattributeaccess");
				this.SetRelatedEntities<Lp.Model.EarlyBound.PrincipalObjectAttributeAccess>("knowledgearticleview_principalobjectattributeaccess", null, value);
		...
		public System.Collections.Generic.IEnumerable<Lp.Model.EarlyBound.SyncError> KnowledgeArticleViews_SyncErrors
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Lp.Model.EarlyBound.SyncError>("KnowledgeArticleViews_SyncErrors", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("KnowledgeArticleViews_SyncErrors");
				this.SetRelatedEntities<Lp.Model.EarlyBound.SyncError>("KnowledgeArticleViews_SyncErrors", null, value);
		...
		public Lp.Model.EarlyBound.KnowledgeArticle knowledgearticle_views
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.KnowledgeArticle>("knowledgearticle_views", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("knowledgearticle_views");
				this.SetRelatedEntity<Lp.Model.EarlyBound.KnowledgeArticle>("knowledgearticle_views", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_knowledgearticleviews_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_knowledgearticleviews_createdby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_knowledgearticleviews_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_knowledgearticleviews_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_knowledgearticleviews_createdonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_knowledgearticleviews_createdonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_knowledgearticleviews_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_knowledgearticleviews_modifiedby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_knowledgearticleviews_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_knowledgearticleviews_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_knowledgearticleviews_modifiedonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_knowledgearticleviews_modifiedonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.TransactionCurrency transactioncurrency_knowledgearticleviews
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.TransactionCurrency>("transactioncurrency_knowledgearticleviews", null);
			}
		}
