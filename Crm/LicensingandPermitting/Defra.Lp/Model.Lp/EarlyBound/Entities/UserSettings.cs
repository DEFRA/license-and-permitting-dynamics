...
namespace Lp.Model.EarlyBound
{
	...
	public partial class UserSettings : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Lp.Model.EarlyBound.BusinessUnit business_unit_user_settings
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.BusinessUnit>("business_unit_user_settings", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("business_unit_user_settings");
				this.SetRelatedEntity<Lp.Model.EarlyBound.BusinessUnit>("business_unit_user_settings", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_usersettings_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_usersettings_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_usersettings_createdonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_usersettings_createdonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_usersettings_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_usersettings_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_usersettings_modifiedonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_usersettings_modifiedonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_usersettingsbase_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_usersettingsbase_createdby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_usersettingsbase_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_usersettingsbase_modifiedby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.TransactionCurrency transactioncurrency_usersettings
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.TransactionCurrency>("transactioncurrency_usersettings", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("transactioncurrency_usersettings");
				this.SetRelatedEntity<Lp.Model.EarlyBound.TransactionCurrency>("transactioncurrency_usersettings", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser user_settings
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("user_settings", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("user_settings");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("user_settings", null, value);
