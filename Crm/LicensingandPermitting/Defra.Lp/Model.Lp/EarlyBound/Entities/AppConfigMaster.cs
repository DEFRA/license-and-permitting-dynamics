...
namespace Lp.Model.EarlyBound
{
	...
	public partial class AppConfigMaster : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Lp.Model.EarlyBound.AppConfigInstance> appconfigmaster_appconfiginstance
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Lp.Model.EarlyBound.AppConfigInstance>("appconfigmaster_appconfiginstance", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("appconfigmaster_appconfiginstance");
				this.SetRelatedEntities<Lp.Model.EarlyBound.AppConfigInstance>("appconfigmaster_appconfiginstance", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_appconfigmaster_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_appconfigmaster_createdby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_appconfigmaster_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_appconfigmaster_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_appconfigmaster_createdonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_appconfigmaster_createdonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_appconfigmaster_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_appconfigmaster_modifiedby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_appconfigmaster_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_appconfigmaster_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_appconfigmaster_modifiedonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_appconfigmaster_modifiedonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.Organization organization_appconfigmaster
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.Organization>("organization_appconfigmaster", null);
			}
		}
