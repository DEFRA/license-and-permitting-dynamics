...
namespace Lp.Model.EarlyBound
{
	...
	public partial class PostLike : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Lp.Model.EarlyBound.SystemUser lk_postlike_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_postlike_createdby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_postlike_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_postlike_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_postlike_createdonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_postlike_createdonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.Organization organization_postlike
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.Organization>("organization_postlike", null);
			}
		}
		...
		public Lp.Model.EarlyBound.Post Post_Likes
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.Post>("Post_Likes", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("Post_Likes");
				this.SetRelatedEntity<Lp.Model.EarlyBound.Post>("Post_Likes", null, value);
