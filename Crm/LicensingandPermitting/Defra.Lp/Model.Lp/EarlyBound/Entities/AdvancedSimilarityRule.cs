...
namespace Lp.Model.EarlyBound
{
	...
	public partial class AdvancedSimilarityRule : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Lp.Model.EarlyBound.AdvancedSimilarityRuleState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Lp.Model.EarlyBound.AdvancedSimilarityRuleState)(System.Enum.ToObject(typeof(Lp.Model.EarlyBound.AdvancedSimilarityRuleState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Lp.Model.EarlyBound.TextAnalyticsEntityMapping> advancedsimilarityrule_textanalyticsentitymapping
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Lp.Model.EarlyBound.TextAnalyticsEntityMapping>("advancedsimilarityrule_textanalyticsentitymapping", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("advancedsimilarityrule_textanalyticsentitymapping");
				this.SetRelatedEntities<Lp.Model.EarlyBound.TextAnalyticsEntityMapping>("advancedsimilarityrule_textanalyticsentitymapping", null, value);
		...
		public Lp.Model.EarlyBound.AzureServiceConnection azureserviceconnection_advancedsimilarityrule
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.AzureServiceConnection>("azureserviceconnection_advancedsimilarityrule", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("azureserviceconnection_advancedsimilarityrule");
				this.SetRelatedEntity<Lp.Model.EarlyBound.AzureServiceConnection>("azureserviceconnection_advancedsimilarityrule", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_advancedsimilarityrule_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_advancedsimilarityrule_createdby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_advancedsimilarityrule_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_advancedsimilarityrule_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_advancedsimilarityrule_createdonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_advancedsimilarityrule_createdonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_advancedsimilarityrule_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_advancedsimilarityrule_modifiedby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_advancedsimilarityrule_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_advancedsimilarityrule_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_advancedsimilarityrule_modifiedonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_advancedsimilarityrule_modifiedonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.Organization organization_advancedsimilarityrule
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.Organization>("organization_advancedsimilarityrule", null);
			}
		}
