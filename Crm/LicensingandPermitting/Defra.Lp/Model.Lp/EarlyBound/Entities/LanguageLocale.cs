...
namespace Lp.Model.EarlyBound
{
	...
	public partial class LanguageLocale : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Lp.Model.EarlyBound.LanguageLocaleState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Lp.Model.EarlyBound.LanguageLocaleState)(System.Enum.ToObject(typeof(Lp.Model.EarlyBound.LanguageLocaleState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Lp.Model.EarlyBound.KnowledgeArticle> knowledgearticle_languagelocaleid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Lp.Model.EarlyBound.KnowledgeArticle>("knowledgearticle_languagelocaleid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("knowledgearticle_languagelocaleid");
				this.SetRelatedEntities<Lp.Model.EarlyBound.KnowledgeArticle>("knowledgearticle_languagelocaleid", null, value);
		...
		public Lp.Model.EarlyBound.Organization languagelocale_organization
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.Organization>("languagelocale_organization", null);
			}
		}
