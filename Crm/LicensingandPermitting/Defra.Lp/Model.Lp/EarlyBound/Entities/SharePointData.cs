...
namespace Lp.Model.EarlyBound
{
	...
	public partial class SharePointData : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Lp.Model.EarlyBound.SystemUser lk_SharePointData_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_SharePointData_createdby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_SharePointData_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_SharePointData_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_SharePointData_createdonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_SharePointData_createdonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_SharePointData_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_SharePointData_modifiedby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_SharePointData_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_SharePointData_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_SharePointData_modifiedonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_SharePointData_modifiedonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_sharepointdata_user
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_sharepointdata_user", null);
			}
		}
		...
		public Lp.Model.EarlyBound.Organization organization_sharepointdata
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.Organization>("organization_sharepointdata", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SharePointDocumentLocation sharepointdata_sharepointdocumentlocation
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SharePointDocumentLocation>("sharepointdata_sharepointdocumentlocation", null);
			}
		}
