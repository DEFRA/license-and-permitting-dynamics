...
namespace Lp.Model.EarlyBound
{
	...
	public partial class SuggestionCardTemplate : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Lp.Model.EarlyBound.SystemUser lk_suggestioncardtemplate_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_suggestioncardtemplate_createdby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_suggestioncardtemplate_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_suggestioncardtemplate_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_suggestioncardtemplate_createdonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_suggestioncardtemplate_createdonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_suggestioncardtemplate_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_suggestioncardtemplate_modifiedby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_suggestioncardtemplate_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_suggestioncardtemplate_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_suggestioncardtemplate_modifiedonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_suggestioncardtemplate_modifiedonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.Organization organization_suggestioncardtemplate
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.Organization>("organization_suggestioncardtemplate", null);
			}
		}
		...
		public Lp.Model.EarlyBound.TransactionCurrency TransactionCurrency_suggestioncardtemplate
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.TransactionCurrency>("TransactionCurrency_suggestioncardtemplate", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("TransactionCurrency_suggestioncardtemplate");
				this.SetRelatedEntity<Lp.Model.EarlyBound.TransactionCurrency>("TransactionCurrency_suggestioncardtemplate", null, value);
