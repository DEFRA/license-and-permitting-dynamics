...
namespace Lp.Model.EarlyBound
{
	...
	public partial class ActionCardUserSettings : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Lp.Model.EarlyBound.BusinessUnit actioncardusersettings_businessunit
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.BusinessUnit>("actioncardusersettings_businessunit", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser actioncardusersettings_owning_user
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("actioncardusersettings_owning_user", null);
			}
		}
		...
		public Lp.Model.EarlyBound.CardType cardtype_actioncardusersettings
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.CardType>("cardtype_actioncardusersettings", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("cardtype_actioncardusersettings");
				this.SetRelatedEntity<Lp.Model.EarlyBound.CardType>("cardtype_actioncardusersettings", null, value);
		...
		public Lp.Model.EarlyBound.Team team_actioncardusersettings
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.Team>("team_actioncardusersettings", null);
			}
		}
