...
namespace Lp.Model.EarlyBound
{
	...
	public partial class ChannelPropertyGroup : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Lp.Model.EarlyBound.ChannelPropertyGroupState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Lp.Model.EarlyBound.ChannelPropertyGroupState)(System.Enum.ToObject(typeof(Lp.Model.EarlyBound.ChannelPropertyGroupState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Lp.Model.EarlyBound.ChannelProperty> ChannelPropertyGroup_ChannelProperty
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Lp.Model.EarlyBound.ChannelProperty>("ChannelPropertyGroup_ChannelProperty", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ChannelPropertyGroup_ChannelProperty");
				this.SetRelatedEntities<Lp.Model.EarlyBound.ChannelProperty>("ChannelPropertyGroup_ChannelProperty", null, value);
		...
		public System.Collections.Generic.IEnumerable<Lp.Model.EarlyBound.ConvertRule> channelpropertygroup_convertrule
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Lp.Model.EarlyBound.ConvertRule>("channelpropertygroup_convertrule", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("channelpropertygroup_convertrule");
				this.SetRelatedEntities<Lp.Model.EarlyBound.ConvertRule>("channelpropertygroup_convertrule", null, value);
		...
		public Lp.Model.EarlyBound.Organization channelpropertygroup_organization
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.Organization>("channelpropertygroup_organization", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_ChannelPropertyGroup_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_ChannelPropertyGroup_createdby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_ChannelPropertyGroup_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_ChannelPropertyGroup_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_ChannelPropertyGroup_createdonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_ChannelPropertyGroup_createdonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_ChannelPropertyGroup_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_ChannelPropertyGroup_modifiedby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_ChannelPropertyGroup_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_ChannelPropertyGroup_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_ChannelPropertyGroup_modifiedonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_ChannelPropertyGroup_modifiedonbehalfby", null, value);
