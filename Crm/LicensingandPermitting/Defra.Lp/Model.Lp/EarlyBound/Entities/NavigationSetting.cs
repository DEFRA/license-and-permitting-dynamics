...
namespace Lp.Model.EarlyBound
{
	...
	public partial class NavigationSetting : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Lp.Model.EarlyBound.SystemUser lk_navigationsetting_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_navigationsetting_createdby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_navigationsetting_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_navigationsetting_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_navigationsetting_createdonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_navigationsetting_createdonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_navigationsetting_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_navigationsetting_modifiedby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_navigationsetting_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_navigationsetting_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_navigationsetting_modifiedonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_navigationsetting_modifiedonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.AppConfig navigationsetting_appconfig
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.AppConfig>("navigationsetting_appconfig", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("navigationsetting_appconfig");
				this.SetRelatedEntity<Lp.Model.EarlyBound.AppConfig>("navigationsetting_appconfig", null, value);
		...
		public Lp.Model.EarlyBound.Organization organization_navigationsetting
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.Organization>("organization_navigationsetting", null);
			}
		}
