...
namespace Lp.Model.EarlyBound
{
	...
	public partial class ActionCardUserState : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public Lp.Model.EarlyBound.ActionCard ActionCardUserState_ActionCard
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.ActionCard>("ActionCardUserState_ActionCard", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("ActionCardUserState_ActionCard");
				this.SetRelatedEntity<Lp.Model.EarlyBound.ActionCard>("ActionCardUserState_ActionCard", null, value);
		...
		public Lp.Model.EarlyBound.TransactionCurrency TransactionCurrency_ActionCardUserState
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.TransactionCurrency>("TransactionCurrency_ActionCardUserState", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("TransactionCurrency_ActionCardUserState");
				this.SetRelatedEntity<Lp.Model.EarlyBound.TransactionCurrency>("TransactionCurrency_ActionCardUserState", null, value);
