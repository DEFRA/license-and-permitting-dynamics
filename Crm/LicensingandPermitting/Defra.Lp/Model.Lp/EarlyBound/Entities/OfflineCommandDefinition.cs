...
namespace Lp.Model.EarlyBound
{
	...
	public partial class OfflineCommandDefinition : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<Lp.Model.EarlyBound.SyncError> OfflineCommandDefinition_SyncErrors
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Lp.Model.EarlyBound.SyncError>("OfflineCommandDefinition_SyncErrors", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("OfflineCommandDefinition_SyncErrors");
				this.SetRelatedEntities<Lp.Model.EarlyBound.SyncError>("OfflineCommandDefinition_SyncErrors", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_offlinecommanddefinition_createdby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_offlinecommanddefinition_createdby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_offlinecommanddefinition_createdonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_offlinecommanddefinition_createdonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_offlinecommanddefinition_createdonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_offlinecommanddefinition_createdonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.SystemUser lk_offlinecommanddefinition_modifiedby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_offlinecommanddefinition_modifiedby", null);
			}
		}
		...
		public Lp.Model.EarlyBound.SystemUser lk_offlinecommanddefinition_modifiedonbehalfby
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_offlinecommanddefinition_modifiedonbehalfby", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("lk_offlinecommanddefinition_modifiedonbehalfby");
				this.SetRelatedEntity<Lp.Model.EarlyBound.SystemUser>("lk_offlinecommanddefinition_modifiedonbehalfby", null, value);
		...
		public Lp.Model.EarlyBound.Organization offlinecommanddefinition_organization
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<Lp.Model.EarlyBound.Organization>("offlinecommanddefinition_organization", null);
			}
		}
