namespace Lp.DataAccess
{
    ...
    /// <summary>
    /// Data access layer used to work with the CRM autonumber entity
    /// </summary>
    public class DataAccessAutoNumber : DataAccessBase
    {
        ...
        /// <summary>
        /// Returns the next auto-number generated string for the given AutoNumber record code
        /// </summary>
        /// <param name="autoNumberName">Auto number code</param>
        /// <returns>Autogenerated string</returns>
        public string GetNextAutoNumber(string autoNumberName)
        {
            ...
            var lockedAutonumber = OrganisationService.Retrieve(
                ...
                new ColumnSet(
                    ...
                    defra_autonumbering.Fields.defra_maxnumber));
            ...
            var maxNumber = lockedAutonumber.Contains(defra_autonumbering.Fields.defra_maxnumber) ?
                (int)lockedAutonumber[defra_autonumbering.Fields.defra_maxnumber] : 0;
